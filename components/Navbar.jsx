...
const Navbar = () => {
  return (
    <div className='flex bg-[#EDEFF2] z-40 sticky top-0 items-center justify-center h-10vh px-2 min-h-10vh justify-between border-b-2 w-full'>
      <div className='flex gap-4 sm:gap-10 sm:grow sm:justify-bewteen'>
      ...
      <ul className='inline-block nb:hidden p-2 list-none gap-2 text-[#7D8FB3] text-menu font-bold flex'>
      ...
      <div className='flex px-4 md:hidden overflow-hidden text-xs items-center justify-between font-bold h-10 bg-white rounded-3xl w-1/5'>
        ...
        <input type="text" className='w-96 nb:w-10 focus:outline-none'  name="search" id="search" placeholder='Search Products, Orders and Clients'/>
      ...
      <div className=' gap-4 flex items-center'>
        <div className='hidden nb:inline relative'>
          <input type="checkbox" className='hidden' id="btn"/>
          <label htmlFor="btn">
            <svg className='inline-block cursor-pointer' width="30" height="31" viewBox="0 0 30 31" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g id="Navigation/more_horiz">
              <path id="Icon" fill-rule="evenodd" clip-rule="evenodd" d="M9 13.5C7.9 13.5 7 14.4 7 15.5C7 16.6 7.9 17.5 9 17.5C10.1 17.5 11 16.6 11 15.5C11 14.4 10.1 13.5 9 13.5ZM21 13.5C19.9 13.5 19 14.4 19 15.5C19 16.6 19.9 17.5 21 17.5C22.1 17.5 23 16.6 23 15.5C23 14.4 22.1 13.5 21 13.5ZM15 13.5C13.9 13.5 13 14.4 13 15.5C13 16.6 13.9 17.5 15 17.5C16.1 17.5 17 16.6 17 15.5C17 14.4 16.1 13.5 15 13.5Z" fill="#C3CAD9"/>
              </g>
            </svg>
            <div id="sm-menu" className='text-xs hidden absolute right-0 bg-white rounded-lg p-2' >
              <p className='text-[#7D8FB3] p-1 hover:text-[#3361FF] cursor-pointer'>Dashboard</p>
              <p className='text-[#7D8FB3] p-1 hover:text-[#3361FF] cursor-pointer '>About Us</p>
              <p className='text-[#7D8FB3] p-1 hover:text-[#3361FF] cursor-pointer'>News</p>
              <p className='text-[#7D8FB3]  p-1 hover:text-[#3361FF] cursor-pointer'>User Policy</p>
              <p className='text-[#7D8FB3]  p-1 hover:text-[#3361FF] cursor-pointer'>Contacts</p>
            </div>
          </label>
        </div>
        <div>
        ...
        <div className='text-[#6B7A99] sm:hidden text-sm'>Clayton Santos</div>
          <div className='p-1 relative bg-white sm:hidden rounded-full'>
            <svg className='absolute bottom-5 left-6' xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 30 31" fill="none">
              <rect x="10" y="10.5" width="10" height="10" rx="5" fill="#E62E7B"/>
            </svg>
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="31" viewBox="0 0 30 31" fill="none">
          ...
          <div className='p-1 bg-white sm:hidden rounded-full'>
            <svg width="30" height="31" viewBox="0 0 30 31" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g id="Icon">
              <path id="Icon_2" fill-rule="evenodd" clip-rule="evenodd" d="M15 5.5C9.47 5.5 5 9.97 5 15.5C5 21.03 9.47 25.5 15 25.5C20.53 25.5 25 21.03 25 15.5C25 9.97 20.53 5.5 15 5.5ZM19.3 19.8C18.91 20.19 18.28 20.19 17.89 19.8L15 16.91L12.11 19.8C11.72 20.19 11.09 20.19 10.7 19.8C10.5127 19.6132 10.4075 19.3595 10.4075 19.095C10.4075 18.8305 10.5127 18.5768 10.7 18.39L13.59 15.5L10.7 12.61C10.5127 12.4232 10.4075 12.1695 10.4075 11.905C10.4075 11.6405 10.5127 11.3868 10.7 11.2C11.09 10.81 11.72 10.81 12.11 11.2L15 14.09L17.89 11.2C18.28 10.81 18.91 10.81 19.3 11.2C19.69 11.59 19.69 12.22 19.3 12.61L16.41 15.5L19.3 18.39C19.68 18.77 19.68 19.41 19.3 19.8Z" fill="#C3CAD9"/>
              </g>
            </svg>
          </div>
        </div>
