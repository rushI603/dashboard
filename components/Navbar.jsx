...
const Navbar = () => {
  return (
    <div className='flex bg-[#EDEFF2] z-40 sticky top-0 items-center justify-center h-10vh px-2 min-h-10vh justify-between border-b-2 w-full'>
      ...
      <div className='flex px-4 md:hidden overflow-hidden text-xs items-center font-bold h-10 bg-white rounded-3xl w-1/5'>
        <svg className='inline-block' width="30" height="31" viewBox="0 0 30 31" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g id="Icon">
        ...
        <input type="text" className='w-96'  name="search" id="search" placeholder='Search Products, Orders and Clients'/>
