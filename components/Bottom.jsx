...
const Bottom = () => {
  ...
  return click ? 
      (
    <div className='bg-white vs:hidden rounded-lg p-4 w-fit fixed bottom-3 right-3'>
        <div className="flex justify-between mb-2">
            <div className="flex items-center font-bold text-[#4D5E80] text-sm">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" onClick={()=>setClick(false)} width="30" height="31" viewBox="0 0 30 31" fill="none">
        ...
        <div className="grid my-4 grid-cols-2 gap-4">
            <div className='text-[#4D5E80] text-xs font-bold flex justify-around items-center'>
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="31" viewBox="0 0 30 31" fill="none">
            ...
            <div className='text-[#4D5E80] text-xs font-bold flex justify-around items-center'>
                <svg className='' xmlns="http://www.w3.org/2000/svg" width="30" height="31" viewBox="0 0 30 31" fill="none">
            ...
            <div className='text-[#4D5E80] text-xs font-bold flex justify-around items-center'>
                <Image
                src={bottom}
                className='bg-[#8833FF4D] rounded-full'
                />
                4 Subtasks
            </div>
        </div>
        ...
        <div className="flex pt-4 gap-4">
            <div className='flex flex-nowrap'>
                <div className=''>
                    <p className='font-bold text-xs text-[#7D8FB3] '>START DATE</p>
                    <p className='font-black text-xs text-[#4D5E80]'>Sep 3, 9:00 pm</p>
                </div>
                <svg className='' xmlns="http://www.w3.org/2000/svg" width="30" height="31" viewBox="0 0 30 31" fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M12.2925 9.79376C11.9025 10.1838 11.9025 10.8138 12.2925 11.2038L16.1725 15.0838L12.2925 18.9638C11.9025 19.3538 11.9025 19.9838 12.2925 20.3738C12.6825 20.7638 13.3125 20.7638 13.7025 20.3738L18.2925 15.7838C18.6825 15.3938 18.6825 14.7638 18.2925 14.3738L13.7025 9.78376C13.3225 9.40376 12.6825 9.40376 12.2925 9.79376Z" fill="#C3CAD9"/>
                </svg>
                
            </div>
            <div className=''>
                <p className='font-bold text-xs text-[#7D8FB3] '>DUE DATE</p>
                <p className='font-black text-xs text-[#4D5E80]'>Sep 4, 9:00 pm</p>
            </div>
            <div className='flex gap-x-2 items-center'>
                <div className='bg-[#29CC39] rounded-full p-2'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M8 8.50114V16.7891C8 17.4211 8.696 17.8051 9.232 17.4611L15.744 13.3171C16.24 13.0051 16.24 12.2851 15.744 11.9651L9.232 7.82914C8.696 7.48514 8 7.86914 8 8.50114Z" fill="white"/>
                    </svg>
                </div>
                <div className='font-black text-xs text-[#4D5E80]'>
                    0:00
                </div>
            </div>
        </div>
    ...
    <div className='bg-white vs:hidden rounded-full w-fit fixed right-2 bottom-2 p-1' onClick={()=>setClick(true)}>
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="31" viewBox="0 0 30 31" fill="none">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M20 10.5H17C16.45 10.5 16 10.95 16 11.5C16 12.05 16.45 12.5 17 12.5H20C21.65 12.5 23 13.85 23 15.5C23 17.15 21.65 18.5 20 18.5H17C16.45 18.5 16 18.95 16 19.5C16 20.05 16.45 20.5 17 20.5H20C22.76 20.5 25 18.26 25 15.5C25 12.74 22.76 10.5 20 10.5ZM11 15.5C11 16.05 11.45 16.5 12 16.5H18C18.55 16.5 19 16.05 19 15.5C19 14.95 18.55 14.5 18 14.5H12C11.45 14.5 11 14.95 11 15.5ZM13 18.5H10C8.35 18.5 7 17.15 7 15.5C7 13.85 8.35 12.5 10 12.5H13C13.55 12.5 14 12.05 14 11.5C14 10.95 13.55 10.5 13 10.5H10C7.24 10.5 5 12.74 5 15.5C5 18.26 7.24 20.5 10 20.5H13C13.55 20.5 14 20.05 14 19.5C14 18.95 13.55 18.5 13 18.5Z" fill="#C3CAD9"/>
        </svg>
    </div>
